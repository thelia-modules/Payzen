...
return array(
    ...
    'If manual is selected, you will have to confirm payments manually in your bank back-office' => 'Si "Manuel" est sélectionné, vous devrez confirmer manuellement les paiements dans votre outil de gestion de caisse.',
    'Italian' => 'Italien',
    'Japanese' => 'Japonais',
    'Languages available on the payment page. Select nothing to use gateway config.' => 'Langage proposés sur la page de paiement. Ne sélectionnez rien pour utiliser les paramètres par défaut de la plate-forme.',
    ...
    'Payzen platform request for order ID %id processing terminated.' => 'Le traitement de la requête de Payzen pour la commande ID %id est terminé.',
    ...
    'Response could not be authenticated.' => 'La réponse Payzen ne peut être authentifiée.',
